...
from agent_platform.db.crud.agent import AgentCRUD
from agent_platform.settings import settings
from agent_platform.web.api.errors import MaxLoopsError, MultipleSummaryError
...
def mock_agent_run_exists(mocker: MockerFixture, exists: bool) -> None:
    mocker.patch("agent_platform.db.models.agent.AgentRun.get", return_value=exists)
